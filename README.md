...
### 🖥️ System & Window Control
- Open / close applications
- Minimize, maximize, and switch windows
- Lock, shutdown, restart, or sleep laptop
- Volume control (up, down, mute)

### 📹 Screen & Media
- Start and stop screen recording by voice
- Take screenshots with timestamp
- Play YouTube videos using voice

### 🌐 Web Automation
- Open Google, YouTube, Gmail, Maps
